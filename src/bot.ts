...
- Если гость просит напиток по вкусу или составу («что-нибудь арбузное», «с кокосом»), используй search_menu и передай одно ключевое слово в начальной форме («арбуз», «кокос»). Предложи найденные варианты.
